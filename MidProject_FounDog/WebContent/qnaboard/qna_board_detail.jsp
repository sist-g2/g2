    ...
    <div class="row">
        ...
        <c:forEach var="rvo" items="${list }">
          ...
          <tr>
           ...
           <tr style="display:none" id="m${rvo.no }" class="reply">
	          <td class="text-left" colspan="2">
	           <form id="boardreply_ReInsert" name="frm" method="post" action="../qnaboard/qna_boardreply_ReInsert.do">
	        ...
	        <tr style="display:none" id="u${rvo.no }" class="update">
	          <td class="text-left" colspan="2">
	           <form id="boardreply_Update" name="frm" method="post" action="../qnaboard/qna_boardreply_Update.do">
      ...
      <c:if test="${sessionScope.id!=null }">
	      <table class="table">
	        <tr>
	          <td class="text-left">
	           <form id="boardreply_Insert" name="frm" method="post" action="../qnaboard/qna_boardreply_Insert.do">
