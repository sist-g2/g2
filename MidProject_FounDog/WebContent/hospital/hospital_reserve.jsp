...
개인정보 수집에 대한 동의
파운독은 귀하께 회원가입시 개인정보보호방침 또는 이용약관의 내용을 공지하며 회원가입버튼을 클릭하면 개인정보 수집에 대해 동의하신 것으로 봅니다.<br>
개인정보의 수집목적 및 이용목적
...
파운독은 상기 범위 내에서 보다 풍부한 서비스를 제공하기 위해 이용자의 자의에 의한 추가정보를 수집합니다.<br>
수집하는 개인정보 항목<br>
